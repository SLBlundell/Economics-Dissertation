...
In order to calculate how many levels of auto-correlations we take into account, i.e. our truncation parameter $L$, we observe both common practice outlined in Greene 2008, dictating $L\approx{T^{1/4}}$, and the results of our PACF.
